...
<main>
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $nurserytwo_id = $_POST["nurserytwo_id"];
    ...
    $sql = "INSERT INTO nurserytwo (nurserytwo_id, hatchery_code, tank_no, stocking_date, stocking_pcs, stocking_size, dayof_culture, harvest_date,transfer_to, harvest_pcs, harvest_size, sizing, total_initial_weight, total_harvest_weight)
      ...
      <form action="nurserytwotransfer.php" method="POST">
        ...
        <div class="form-row">
          <div class="form-group col-md-2">
            ...
            <input type="number" class="form-control" name="nurserytwo_id" id="nurserytwo_id">
          </div>
          <div class="form-group col-md-2">
